            ...
            <div className="rounded-lg border p-3 space-y-1 text-sm bg-muted/30">
              {data.service_name && (
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Serviço — {data.service_name}</span>
                  <span>{fmt(data.charge.serviceAmount)}</span>
                </div>
              )}
              {data.charge.materialLines.map((l, i) => (
              ...
              <div className="flex justify-between font-semibold pt-2 border-t">
                <span>Total</span>
                <span>{fmt(data.charge.totalAmount)}</span>
              </div>
            </div>
