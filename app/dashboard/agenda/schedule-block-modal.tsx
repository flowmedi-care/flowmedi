...
export function ScheduleBlockModal({
  ...
  useEffect(() => {
    ...
    if (initialPartial?.doctorId) {
      ...
      setScope(canBlockClinic ? "doctor" : "doctor");
      setDoctorId(doctors[0]?.id ?? "");
    }
    ...
    setForm(base);
  }, [open, editingBlockId, doctors, isDoctor, canBlockClinic, initialPartial]);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <h2 className="text-lg font-semibold">
              {isEdit ? "Editar período indisponível" : "Bloquear horário"}
            </h2>
            <p className="text-sm text-muted-foreground">
              Consultas não poderão ser agendadas neste intervalo.
            </p>
          </div>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          patchForm({ recurrenceStartDate: e.target.value })
                        }
                        required
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="space-y-2">
                      ...
                      >
                        {(Object.keys(RECURRENCE_FREQUENCY_LABELS) as RecurrenceFrequency[]).map(
                          (f) => (
