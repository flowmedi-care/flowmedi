...
function StepperTrigger({ asChild = false, className, children, tabIndex, ...props }: StepperTriggerProps) {
  ...
  return (
    <button
      ...
      className={cn(
        'cursor-pointer focus-visible:border-ring focus-visible:ring-ring/50 inline-flex items-center gap-2 rounded-full outline-none focus-visible:z-10 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-60 px-1 py-1',
        className,
      )}
...
function StepperSeparator({ className }: React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        'm-0.5 rounded-full bg-muted group-data-[state=completed]/step:bg-primary/40 group-data-[orientation=vertical]/stepper-nav:h-12 group-data-[orientation=vertical]/stepper-nav:w-0.5 group-data-[orientation=horizontal]/stepper-nav:h-0.5 group-data-[orientation=horizontal]/stepper-nav:flex-1',
        className,
      )}
    />
  );
...
function StepperTitle({ children, className }: React.ComponentProps<'h3'>) {
  ...
  return (
    <h3
      ...
      data-state={state}
      className={cn(
        'text-xs sm:text-sm font-medium leading-none whitespace-nowrap data-[state=inactive]:text-muted-foreground data-[state=active]:text-primary data-[state=completed]:text-foreground',
        className,
      )}
    >
      {children}
